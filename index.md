...
Hello! My name is Lin (she/her). I am a PhD student at the [Max Planck Institute for Security and Privacy (MPI-SP)](https://www.mpi-sp.org/) where I am supervised by [Asia Biega](https://asiabiega.github.io/) in the Responsible Computing Group. I am an incoming postdoc at [EPFL](https://www.epfl.ch/en/), joining [Miranda Wei](https://mirandawei.com/)'s group, starting in December. My research is focused on building stronger foundations for online consent in the age of AI to promote better user privacy, safety, and data autonomy.    
